...
const NotificationManagement = () => {
  ...
  const handleDisable = async (id) => {
    try {
      ...
      if (!res.ok) throw new Error("Failed to disable notification");
      ...
      setError("Failed to disable notification");
    }
  };
  ...
  const handleEnable = async (id) => {
    try {
      ...
      setError("Failed to enable notification");
    }
  };
  ...
  const filteredNotifications = notifications.filter((notification) => {
    ...
    const matchesStatus =
      ...
      (filterStatus === "disabled" && notification.isDeleted);
      ...
      <div className="flex justify-between items-start mb-4 sm:mb-5">
        <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              {notification.isDeleted ? "Disabled" : "Active"}
            </span>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-gray-100">
      ...
      {isEditOpen && selectedNotification && (
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6 sm:mb-8">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Edit Notification</h2>
              <button 
                onClick={() => setIsEditOpen(false)}
                className="p-1 hover:bg-gray-100 rounded-md"
              >
