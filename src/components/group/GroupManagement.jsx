  ...
  const GroupCard = ({ group }) => (
    ...
    >
      <div className="flex justify-between items-start mb-4 sm:mb-5">
        ...
        <button
          type="button"
          onClick={(e) => { e.preventDefault(); e.stopPropagation(); setShowDropdown(showDropdown === group._id ? null : group._id); }}
        ...
        {showDropdown === group._id && (
          <div className="absolute right-2 sm:right-6 top-12 sm:top-14 bg-white rounded-lg shadow-xl border py-2 sm:py-3 z-20 w-40 sm:w-48 text-sm sm:text-lg">
            <button
              type="button"
              onClick={(e) => { e.preventDefault(); e.stopPropagation(); setSelectedGroup(group); setIsEditOpen(true); setShowDropdown(null); }}
            ...
            {group.isDeleted ? (
              <button
                type="button"
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); handleEnable(group._id); setShowDropdown(null); }}
              ...
              <button
                type="button"
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); if (window.confirm("Disable this group?")) { handleDisable(group._id); setShowDropdown(null); } }}
